...
export const getSuggestedUsers = async (req, res) => {
    try {
        ...
        // Take users that have different id to auth user
        ...
        // Take out users that auth user is not following
...
export const updateUser = async (req, res) => {
    ...
    try {
        ...
        // Password should be null in the reponse
        user.password = null
